...
const RolesPage = lazy(() => import("./pages/RolesPage.tsx"));
const RoleDetailPage = lazy(() => import("./pages/RoleDetailPage.tsx"));
const AssessmentPage = lazy(() => import("./pages/AssessmentPage.tsx"));
const ResultsPage = lazy(() => import("./pages/ResultsPage.tsx"));
const SkillGapPage = lazy(() => import("./pages/SkillGapPage.tsx"));
const LearningPlanPage = lazy(() => import("./pages/LearningPlanPage.tsx"));
          ...
          <BrowserRouter>
            ...
            <Suspense fallback={<RouteLoading />}>
              <Routes>
                ...
                {/* Assessment runs full-screen (no sidebar) */}
                <Route
